...
export default function Room() {
    ...
    const ChangeStartingDate = (newValue) => {
        console.log(newValue);
        setStartingDate(newValue);
    };

    const ChangeEndingDate = (newValue) => {
        console.log(newValue);
    ...
    return (
        <Grid style={{marginLeft:"100px",marginRight:"50px" , paddingTop:"30px"}} >
            <Table>
                <TableHead style={{backgroundColor: "#1717cf"}}>
                    <TableRow >
                        ...
                        <TableCell style={{color:"#e0e0e0", fontWeight:"bold", fontSize:"20px"}}>Reserve</TableCell>
                    </TableRow>
                </TableHead>
                ...
                <TableRow hover key={room.id} >
                    ...
                    <TableCell ><Button variant="contained" size='small' value={room.id} onClick={handleClickOpen}>Reserve Room</Button></TableCell>
                </TableRow>
            ...
            <Dialog open={open} onClose={handleClose} fullWidth={true} maxWidth='sm'>
                <DialogTitle style={{backgroundColor:"#1976d2", color:"white", fontWeight:"bold", textAlign:"center"}}>Make Reservation</DialogTitle>
                    ...
                    <Grid alignItems="center" justifyContent="center">
                        ...
                        <DesktopDatePicker 
                            ...
                            value={startingDate}
                            onChange={ChangeStartingDate}
                            renderInput={(params) => <TextField {...params} />}
                        />
                        </LocalizationProvider>
                        </Grid>
                        <Grid item sm={8} style={{paddingLeft:"160px", paddingTop:'10px'}}>
                        <LocalizationProvider dateAdapter={AdapterDateFns}>
                        <DesktopDatePicker 
                            label="Ending Date"
                            inputFormat="MM/dd/yyyy"
                            value={endingDate}
                            onChange={ChangeEndingDate}
                            renderInput={(params) => <TextField {...params} />}
                        />
                        </LocalizationProvider>
                        </Grid>
                    ...
                    <DialogActions>
                        ...
                        <Button onClick={BookReservation} variant='contained' style={{color:"white", fontWeight:"bold"}}>Save</Button>
                    </DialogActions>
            </Dialog>
